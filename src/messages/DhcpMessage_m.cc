...
void DhcpMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->proposedAddress);
}
...
void DhcpMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->proposedAddress);
}

const char * DhcpMessage::getType() const
{
    return this->type.c_str();
}

void DhcpMessage::setType(const char * type)
{
    this->type = type;
}

int DhcpMessage::getClientId() const
{
    return this->clientId;
}

void DhcpMessage::setClientId(int clientId)
{
    this->clientId = clientId;
}

int DhcpMessage::getProposedAddress() const
{
    return this->proposedAddress;
}

void DhcpMessage::setProposedAddress(int proposedAddress)
{
...
unsigned int DhcpMessageDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_proposedAddress
    };
...
int DhcpMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "proposedAddress") == 0) return baseIndex + 2;
...
std::string DhcpMessageDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_proposedAddress: return long2string(pp->getProposedAddress());
        default: return "";
    }
}
...
void DhcpMessageDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_proposedAddress: pp->setProposedAddress(string2long(value)); break;
...
omnetpp::cValue DhcpMessageDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_proposedAddress: return pp->getProposedAddress();
...
void DhcpMessageDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_proposedAddress: pp->setProposedAddress(omnetpp::checked_int_cast<int>(value.intValue())); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'DhcpMessage'", field);
    }
}
